...
#define cmt_spi3_csb_1()        HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3, GPIO_PIN_SET)
#define cmt_spi3_csb_0()        HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3, GPIO_PIN_RESET)

#define cmt_spi3_fcsb_1()       HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_SET)
#define cmt_spi3_fcsb_0()       HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_RESET)
    
#define cmt_spi3_sclk_1()       HAL_GPIO_WritePin(GPIOB, GPIO_PIN_2, GPIO_PIN_SET)
#define cmt_spi3_sclk_0()       HAL_GPIO_WritePin(GPIOB, GPIO_PIN_2, GPIO_PIN_RESET)

#define cmt_spi3_sdio_1()       HAL_GPIO_WritePin(GPIOB, GPIO_PIN_4, GPIO_PIN_SET)
#define cmt_spi3_sdio_0()       HAL_GPIO_WritePin(GPIOB, GPIO_PIN_4, GPIO_PIN_RESET)
#define cmt_spi3_sdio_read()    HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_4)
/* ************************************************************************ */
...
void cmt_spi3_init(void)
{
	...
	GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_PIN_5;						/* CSB  FCSB*/
